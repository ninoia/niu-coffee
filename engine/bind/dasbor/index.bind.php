<!DOCTYPE html>
 ...
 <head>
  ...
  <link rel="stylesheet" href="<?=STYLEBASE; ?>/dasbor/stisla/css/niucoffee.css">
 ...
 <body style="font-family: 'Nunito Sans';">
       ...
       <div class="main-sidebar" id='divMenu'>
        <aside id="sidebar-wrapper">
            <div class="sidebar-brand">
              ...
              <img src='<?=STYLEBASE; ?>/login/images/logo.png' style="width: 100px;">
              </a>
            </div>
       ...
       <div class="main-content">
         <section class="section">
           <div class="section-header">
             <h1 id='capUtama'> NIU Coffee & Eatery - {{judulForm}}</h1>
   ...
   <footer class="main-footer" id='divFooter'>Copyright &copy; {{tahun}} - NIU Coffee & Eatery</footer>
   <!-- General JS Scripts -->
