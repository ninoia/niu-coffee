    ...
    <div class="container">
        ...
        <div class="footer-second-row row align-items-center">
            <div class="col-lg-4 text-center text-md-left">
                <span class="text-sm text-muted">NIU Coffee & Eatery, Pamulang</span>
            </div>
            ...
            <div class="col-lg-4 col-md-6 text-center text-md-right">
                ...
                <a href="https://www.instagram.com/niucoffee" class="icon icon-social icon-circle icon-sm icon-instagram"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
