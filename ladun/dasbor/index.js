...
var divMenu = new Vue({
  ...
  methods: {
    ...
    {
     renderMenu(pesanan);
     divJudul.judulForm = "Riwayat Pesanan"; 
    },
    ...
    {
      pesanUmumApp('info', 'Contact Haxors', 'Fitur ini membutuhkan service firebase, silahkan kontak GigihDwiHananto untuk mengaktifkan fungsi ini');
    },
